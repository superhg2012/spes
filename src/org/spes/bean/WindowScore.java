...
/**
 * WindowScore entity. @author MyEclipse Persistence Tools
 */

public class WindowScore implements java.io.Serializable {
	...
	/** full constructor */
	public WindowScore(String itemName, Double itemScore,
			Timestamp evaluateDate, String calculator, Integer itemId,
			Integer windowId, Integer centerId, String evaluated, String sheetType,
