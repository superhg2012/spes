var ManageSheet = (function (){
    ...
    var buttonRender = function (value, metadata, record, rowIndex, colIndex, store) {
		...
		formattedPosition += '&nbsp; &nbsp;&nbsp;&nbsp;';
  	    formattedPosition += '<a title="详细考核信息" style="cursor:pointer;" href="javascript:void(0);" onclick="ManageSheet.onClickDisplaySheetDetailInfos(\'' + value + '\');"><i class="icon-zoom-in"></i></a>';
